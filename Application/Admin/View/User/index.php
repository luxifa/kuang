                    ...
                    <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php foreach($userList as $userRow){?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo (int)$userRow['ore_total']?></td>
                                        <td><?php echo (int)$userRow['oremachine_num']?></td>
                        ...
                        <ul class="pagination">
                            <?php for ($i = 1;$i <= $totalPage; $i++){?>
                                ...
                                ?>
                                <?php if($pageNow > 1){?>
                                    <li><a href="/admin/user?page=<?php echo $pageNow-1;?>">&laquo;</a></li>
                                <?php }?>
                                <?php
                                if($totalPage > 6 && $i==3) echo '...';
                                ?>
                                <li><a href="/admin/user?page=<?php echo $i;?>">1</a></li>
