...
<div class="main">
    ...
    <div class="form">
        ...
        <form action="" method="post">
            <label class="ipt"><span>旧密码：</span><input type="password" name="oldPassword" class="iptText"/></label>
            <label class="ipt"><span>新密码：</span><input type="password" name="newPassword" class="iptText"/></label>
            <label class="ipt"><span>确认密码：</span><input type="password" name="newPassword2" class="iptText"/></label>
